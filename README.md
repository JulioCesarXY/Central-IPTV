## 🗂️ Diretório de Extratores (EPG Scrapers)

Uma coleção de scripts e ferramentas automatizadas para extração de guias de programação (EPG) e fluxos de diferentes plataformas de streaming.
...
| 📺 **Clube Canais** | [`EPG-ClubeCanais`](https://github.com/JulioCesarXY/EPG-ClubeCanais) | ![Novo](https://img.shields.io/badge/-Novo-brightgreen) |
...
| 🍇 **Soul TV** | [`EPG-SOULTV`](https://github.com/JulioCesarXY/EPG-SOULTV) | `Ativo` |
...
2. Crie uma nova **Branch** para sua feature (`git checkout -b feature/NovaPlataforma`).
